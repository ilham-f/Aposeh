        ...
        <div class="w-full overflow-x-auto">
            ...
            > --}}
              ...
              ></div> --}}
                ...
                <a href="/obat/riwayat/cetak" target="_blank"><button data-text="Awesome" class="button">
                    <span class="actual-text">&nbsp;Save As PDF&nbsp;</span>
                    {{-- <span class="hover-text" aria-hidden="true">&nbsp;Save As PDF&nbsp;</span> --}}
                </button></a>
            </table>
        </div>
        <a href="/obat/riwayat">
