          ...
          <div class="container px-6 mx-auto grid">
            ...
            >
              <div class="flex items-center">
                ...
                <span>Edit Keyword & Reply Chat</span>
              </div>
            </a>
            ...
            <form action="{{url('Auto-ReplyChat/'.$data->id) }}" method="POST" >
              ...
              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Keyword</span>
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="keyword" name="keyword" value="{{$data->keyword}}"
                />
              </label><br>

              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400" >Template Chat</span>
                <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="Template Chat" name="reply_chat" value="{{$data->reply_chat}}"
                />
              </label><br>
