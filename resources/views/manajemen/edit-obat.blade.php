      ...
      <!-- Backdrop -->
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <form action="{{ url('pegawai/obat/'.$data->id) }}" method="POST" >
                @method('put')
                @csrf
              <label class="block text-sm">
                ...
                <input
                  ...
                  placeholder="nama Obat" name="nama_obat" value="{{ $data->nama_obat }}"
                />
              </label><br>
              ...
              <label class="block text-sm">
                ...
                <select class="form-select" name="status" data-control="select2" data-placeholder="Select an option" @error('status') is-invalid
                    @enderror id="status">
                ...
                {{-- <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="status" name="status" value="{{ $data->status }}"
                /> --}}
              </label><br>
