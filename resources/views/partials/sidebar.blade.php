        ...
        <template x-if="isPegawaiMenuOpen">
          ...
          >
            <li
              class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
            >
              <a class="w-full" href="pages/login.html">Tambah Data</a>
            </li>
          </ul>
        </template>
      </li>
          ...
          <template x-if="isMemberMenuOpen">
            ...
            >
              <li
                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
              >
                <a class="w-full" href="pages/login.html">Kelola Member</a>
              </li>
            </ul>
          </template>
        </li>
          ...
          <template x-if="isRekapMenuOpen">
            ...
            >
              <li
                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
              >
                <a class="w-full" href="rekaptransaksi">Transaksi</a>
              </li>
            </ul>
          </template>
        </li>
